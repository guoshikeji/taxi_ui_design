...
#### 此版本设计图目前严禁应用于商业项目（待正式开源后方可运用于商业项目） 仅供学习交流

### 产品说明

目前市面绝对大多数网约车产品均已参考DiDi作为开发原型，DiDi在网约车的道路上一直没有找到更好的盈利点，MeiTuan加入网约车让整个出行形成了完整的商业形态，本团队在14年开始涉足网约车行业，为国内40多家网约车公司或出租车公司提供相应的技术支持。
目前中国网约车牌照有150家，但是真正运营起来的寥寥无几，大部分出租车公司拥有比DiDi拥有更好的资源，但是相对来说技术较为落后。

2020年12月我们加入了极简版本的微信公众账号一键叫车功能，用户只需要关注公众号绑定手机号码即可发送一键呼叫，目前该产品模式已经得到很好的市场验证。
关注 - 绑定账号 - 发送一键叫车几乎在25秒内完成操作，获客成本低廉，整个公众号均为微信原生控件的支持，用户体验一流。
##### 下载方法：
```
1、安装Git软件
